...
## Status: deferred
2.8ms, output-bound: q8 has no LIMIT, so all ~11k topic uris are resolved regardless. Already iterates the typed subset and reads the materialized tag edge. Low priority.

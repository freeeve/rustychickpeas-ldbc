...
Spec: weighted SSSP over OUTGOING edges (undirected: both), sum of weights. unreachable=f64::INFINITY. wrap core g.dijkstra, weight=g.relationship_property(rel.pos,"weight").

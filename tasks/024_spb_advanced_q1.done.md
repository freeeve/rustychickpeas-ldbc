...
**Goal.** Faithful hand-coded rustychickpeas implementation of SPB advanced q1 (no SPARQL engine), matching the official query template.

**Source SPARQL:** `data/spb/ldbc_spb_bm_2.0/datasets_and_queries/sparql/advanced/aggregation_standard/query1.txt` (local SPB checkout; the `{{{...}}}` placeholders are substitution parameters).
